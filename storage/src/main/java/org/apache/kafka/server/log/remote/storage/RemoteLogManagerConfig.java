...
public final class RemoteLogManagerConfig {
    ...
    private final Supplier<AbstractConfig> config;
    ...
    public boolean isRemoteStorageSystemEnabled() {
        return config.get().getBoolean(REMOTE_LOG_STORAGE_SYSTEM_ENABLE_PROP);
    }

    public String remoteStorageManagerClassName() {
        return config.get().getString(REMOTE_STORAGE_MANAGER_CLASS_NAME_PROP);
    }

    public String remoteStorageManagerClassPath() {
        return config.get().getString(REMOTE_STORAGE_MANAGER_CLASS_PATH_PROP);
    }

    public String remoteLogMetadataManagerClassName() {
        return config.get().getString(REMOTE_LOG_METADATA_MANAGER_CLASS_NAME_PROP);
    }

    public String remoteLogMetadataManagerClassPath() {
        return config.get().getString(REMOTE_LOG_METADATA_MANAGER_CLASS_PATH_PROP);
    }
    ...
    public int remoteLogManagerCopierThreadPoolSize() {
        return config.get().getInt(REMOTE_LOG_MANAGER_COPIER_THREAD_POOL_SIZE_PROP);
    }

    public int remoteLogManagerExpirationThreadPoolSize() {
        return config.get().getInt(REMOTE_LOG_MANAGER_EXPIRATION_THREAD_POOL_SIZE_PROP);
    }

    public int remoteLogManagerFollowerThreadPoolSize() {
        if (config.get().originals().containsKey(REMOTE_LOG_MANAGER_FOLLOWER_THREAD_POOL_SIZE_PROP)) {
            return config.get().getInt(REMOTE_LOG_MANAGER_FOLLOWER_THREAD_POOL_SIZE_PROP);
        } else {
            return config.get().getInt(REMOTE_LOG_MANAGER_THREAD_POOL_SIZE_PROP);
        }
    }

    public long remoteLogManagerTaskIntervalMs() {
        return config.get().getLong(REMOTE_LOG_MANAGER_TASK_INTERVAL_MS_PROP);
    }
    ...
    public long remoteLogManagerTaskRetryBackoffMs() {
        return config.get().getLong(REMOTE_LOG_MANAGER_TASK_RETRY_BACK_OFF_MS_PROP);
    }
    ...
    public long remoteLogManagerTaskRetryBackoffMaxMs() {
        return config.get().getLong(REMOTE_LOG_MANAGER_TASK_RETRY_BACK_OFF_MAX_MS_PROP);
    }
    ...
    public double remoteLogManagerTaskRetryJitter() {
        return config.get().getDouble(REMOTE_LOG_MANAGER_TASK_RETRY_JITTER_PROP);
    }

    public int remoteLogReaderThreads() {
        return config.get().getInt(REMOTE_LOG_READER_THREADS_PROP);
    }

    public int remoteLogReaderMaxPendingTasks() {
        return config.get().getInt(REMOTE_LOG_READER_MAX_PENDING_TASKS_PROP);
    }

    public String remoteLogMetadataManagerListenerName() {
        return config.get().getString(REMOTE_LOG_METADATA_MANAGER_LISTENER_NAME_PROP);
    }

    public int remoteLogMetadataCustomMetadataMaxBytes() {
        return config.get().getInt(REMOTE_LOG_METADATA_CUSTOM_METADATA_MAX_BYTES_PROP);
    }
    ...
    public String remoteStorageManagerPrefix() {
        return config.get().getString(REMOTE_STORAGE_MANAGER_CONFIG_PREFIX_PROP);
    }
    ...
    public String remoteLogMetadataManagerPrefix() {
        return config.get().getString(REMOTE_LOG_METADATA_MANAGER_CONFIG_PREFIX_PROP);
    }
    ...
    public Map<String, Object> getConfigProps(String configPrefixProp) {
        String prefixProp = config.get().getString(configPrefixProp);
        return prefixProp == null ? Map.of() : Collections.unmodifiableMap(config.get().originalsWithPrefix(prefixProp));
    }

    public int remoteLogManagerCopyNumQuotaSamples() {
        return config.get().getInt(REMOTE_LOG_MANAGER_COPY_QUOTA_WINDOW_NUM_PROP);
    }

    public int remoteLogManagerCopyQuotaWindowSizeSeconds() {
        return config.get().getInt(REMOTE_LOG_MANAGER_COPY_QUOTA_WINDOW_SIZE_SECONDS_PROP);
    }

    public int remoteLogManagerFetchNumQuotaSamples() {
        return config.get().getInt(REMOTE_LOG_MANAGER_FETCH_QUOTA_WINDOW_NUM_PROP);
    }

    public int remoteLogManagerFetchQuotaWindowSizeSeconds() {
        return config.get().getInt(REMOTE_LOG_MANAGER_FETCH_QUOTA_WINDOW_SIZE_SECONDS_PROP);
    }

    public long remoteLogIndexFileCacheTotalSizeBytes() {
        return config.get().getLong(REMOTE_LOG_INDEX_FILE_CACHE_TOTAL_SIZE_BYTES_PROP);
    }

    public long remoteLogManagerCopyMaxBytesPerSecond() {
        return config.get().getLong(REMOTE_LOG_MANAGER_COPY_MAX_BYTES_PER_SECOND_PROP);
    }

    public long remoteLogManagerFetchMaxBytesPerSecond() {
        return config.get().getLong(REMOTE_LOG_MANAGER_FETCH_MAX_BYTES_PER_SECOND_PROP);
    }

    public int remoteFetchMaxWaitMs() {
        return config.get().getInt(REMOTE_FETCH_MAX_WAIT_MS_PROP);
    }

    public long logLocalRetentionBytes() {
        return config.get().getLong(RemoteLogManagerConfig.LOG_LOCAL_RETENTION_BYTES_PROP);
    }

    public long logLocalRetentionMs() {
        return config.get().getLong(RemoteLogManagerConfig.LOG_LOCAL_RETENTION_MS_PROP);
    }

    public long remoteListOffsetsRequestTimeoutMs() {
        return config.get().getLong(REMOTE_LIST_OFFSETS_REQUEST_TIMEOUT_MS_PROP);
    }
